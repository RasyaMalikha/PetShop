...
namespace PetShop
{
    public partial class Manager : Form
    {
        ...
        private void DisplayManajer()
        {
            Con.Open();
            string Query = "Select * from ManajerTbl";
        ...
        private void SaveBtn_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    Con.Open();
                    SqlCommand cmd = new SqlCommand("INSERT INTO ManajerTbl (MnjName, MnjPhone, MnjPass) VALUES (@EN,@EA,@EP)", Con);
        ...
        private void EditBtn_Click(object sender, EventArgs e)
        {
            if (ManajerDGV.SelectedRows.Count > 0)
            {
                ...
                int productId = Convert.ToInt32(ManajerDGV.SelectedRows[0].Cells["MnjNum"].Value);
                ...
                string query = "UPDATE ManajerTbl SET MnjName = @EmployeeName, MnjPhone = @Phone, MnjPass = @Password WHERE MnjNum = @EmployeeNumber";
        ...
        private void DeleteBtn_Click(object sender, EventArgs e)
        {
            if (ManajerDGV.SelectedRows.Count > 0)
            {
                int Employeenumber = Convert.ToInt32(ManajerDGV.SelectedRows[0].Cells["MnjNum"].Value);
                string query = "DELETE FROM ManajerTbl WHERE MnjNum = @EmployeeName";
        ...
        private void EmployeeDGV_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (e.RowIndex >= 0)
            {
                ...
                string EmpName = row.Cells["MnjName"].Value.ToString();
                string EmpAdd = row.Cells["MnjPhone"].Value.ToString();
                string EmpPhone = row.Cells["MnjPass"].Value.ToString();
